...
$name2 = $phone2 = $email2 = $numoftickets2 = $message2 = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit2"])) {
    ...
    $message2 = mysqli_real_escape_string($connect, $_POST["message2"]);

    if($name_error2 == "" && $phone_error2 == "" && $email_error2 == "" && $numoftickets_error2 == "") {
    $query = "INSERT INTO berlin (name, phone, email, numoftickets, message) VALUES ('$name2','$phone2','$email2','$numoftickets2', '$message2')";
...
<form method="post" class="form">
    <div class="form-group header">
        <p class="place">You want to get reservation for a concert in:<br>Berlin, Festhalle Opera 20, 8th March 2018 @ 21:00h?</p>
    ...
    <div class="container">
        ...
        <div class="form-group field">
            <textarea name="message2" class="form-control purchase" placeholder="If you have any additional questions or requests, write them here! :)" rows="5"><?php echo $message2 ?></textarea>   
        </div>
        <button type="submit" name="submit2" class="order">Reserve!</button>
    </div>
</form>
